...
SQI_Object *SQI_BWindow::PulseRate(SQI_Squirrel *squirrel,SQI_Args *inputs)
{
	...
	if(cmd)
	{
		string *str = cmd->Data();
		if(*str == "get")
			return squirrel->LocalHeap->Number((long)(Window->PulseRate()));
		else
		if(*str == "set")
		{
			if(inputs->Length()==3)
...
SQI_Object *SQI_BWindow::Title(SQI_Squirrel *squirrel,SQI_Args *inputs)
{
	...
	if(cmd)
	{
		string *str = cmd->Data();
		if(*str == "get")
			return squirrel->LocalHeap->String(Window->Title());
		else
		if(*str == "set")
		{
			if(inputs->Length()==3)
		...
		if(*str == "get")
		{
			...
			{	
				case B_MODAL_WINDOW_LOOK:
					return squirrel->LocalHeap->Keyword("modal");
				case B_BORDERED_WINDOW_LOOK:
					return squirrel->LocalHeap->Keyword("bordered");
				case B_TITLED_WINDOW_LOOK:
					return squirrel->LocalHeap->Keyword("titled");
				case B_DOCUMENT_WINDOW_LOOK:
					return squirrel->LocalHeap->Keyword("document");
				case B_NO_BORDER_WINDOW_LOOK:
					return squirrel->LocalHeap->Keyword("no.bordered");
				case B_FLOATING_WINDOW_LOOK:
					return squirrel->LocalHeap->Keyword("floating");	
			}	
		}	
		else
		if(*str == "set")
		...
		if(*str == "get")
		{
			...
			{	
				case B_NORMAL_WINDOW_FEEL:
					return squirrel->LocalHeap->Keyword("normal");
				case B_MODAL_SUBSET_WINDOW_FEEL:
					return squirrel->LocalHeap->Keyword("modal.subset");
				case B_MODAL_APP_WINDOW_FEEL:
					return squirrel->LocalHeap->Keyword("modal.app");
				case B_MODAL_ALL_WINDOW_FEEL:
					return squirrel->LocalHeap->Keyword("modal.all");
				case B_FLOATING_SUBSET_WINDOW_FEEL:
					return squirrel->LocalHeap->Keyword("floating.subset");
				case B_FLOATING_APP_WINDOW_FEEL:
					return squirrel->LocalHeap->Keyword("floating.app");
				case B_FLOATING_ALL_WINDOW_FEEL:
					return squirrel->LocalHeap->Keyword("floating.all");	
			}	
		}	
		else
		if(*str == "set")
...
SQI_Object *SQI_BWindow::Zoom(SQI_Squirrel *squirrel,SQI_Args *inputs)
{
	...
	if(cmd)
	{
		...
		if(*str == "get")
		{
			...
			lst->Add2End(squirrel->LocalHeap->Number(Window->zoom_max_w));
			lst->Add2End(squirrel->LocalHeap->Number(Window->zoom_max_h));
